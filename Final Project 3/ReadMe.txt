...
● Download “Project.Java” and put it in a folder with the same name 
● Download Project.Java/src that should contain:
○ All images 
○ ACRinse.txt 
○ json-simple-1.1.jar 
● Download JSON external libraries using this link: 
http://www.java2s.com/Code/Jar/j/Downloadjsonsimple11jar.htm 
To compile: 
Direct the terminal to the source folder of your Project folder. 
